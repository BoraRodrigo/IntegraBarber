                            ...
                            if (!txtCidade.getText().toString().isEmpty()) {
                                if (!txtCEP.getText().toString().isEmpty()) {
                                    if (!txtnumero.getText().toString().isEmpty()) {
                                       if(!estadoSpinner.getSelectedItem().toString().equals("Estado")){
                                            ...
                                            barbearia.setEstado(estadoSpinner.getSelectedItem().toString());
                                            ...
                                            Toast.makeText(getApplicationContext(), "Preencha o Estado", Toast.LENGTH_SHORT).show();
                                        }
                                    }else{
        ...
        usuReference.child("barbearia").orderByChild("id").equalTo(barbeiro.getId()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    ...
                    estadoSpinner.setSelection(((ArrayAdapter) estadoSpinner.getAdapter()).getPosition(barbearia.getEstado()));
